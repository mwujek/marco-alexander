	...
	$redux_sections[] = array(
		...
		'fields'     => array(
			array(
				...
				'type' => 'info',
				'desc' => '<h4 class="title">' . __('Twitter Feed', IRON_TEXT_DOMAIN) . '</h4><br><a href="http://support.irontemplates.com/solution/articles/13000012323-how-to-get-my-twitter-api-keys-" target="_blank">Click here</a> to know how to get your Twitter keys.',
			),
			array(
				'id' => 'twitter_consumerkey',
				'type' => 'text',
				'title' => __('Twitter Consumer Key (API Key)', IRON_TEXT_DOMAIN),
				'std' => ''
			),
			array(
				'id' => 'twitter_consumersecret',
				'type' => 'text',
				'title' => __('Twitter Consumer Secret (API Secret)', IRON_TEXT_DOMAIN),
				'std' => ''
			),
			array(
				'id' => 'twitter_accesstoken',
				'type' => 'text',
				'title' => __('Twitter Access Token', IRON_TEXT_DOMAIN),
				'std' => ''
			),
			array(
				'id' => 'twitter_accesstokensecret',
				'type' => 'text',
				'title' => __('Twitter Access Token Secret', IRON_TEXT_DOMAIN),
				'std' => ''
			),
			array(
				'id' => 'title_facebooklike',
				'type' => 'info',
				'desc' => '<h4 class="title">' . __('Facebook Like', IRON_TEXT_DOMAIN) . '</h4>'
			),
			array(
				'id' => 'facebook_appid',
				'type' => 'text',
			...
			array(
				...
				'type' => 'info',
				'desc' => '<h4 class="title">' . __('Share buttons', IRON_TEXT_DOMAIN) . '</h4>'
			),
			array(
...
'
			...
			array(
				...
				'type' => 'info',
				'desc' => '<h4 class="title">' . __('Header & Footer Social Icons', IRON_TEXT_DOMAIN) . '</h4>'
			),
			array(
				'id'       => 'social_icons',
				'type'     => 'group',
