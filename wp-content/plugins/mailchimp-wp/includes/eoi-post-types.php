		...
		<div id="fca_eoi_publish_lightbox_mode_traditional_popup" class="hidden">
			...
			foreach ( $saved_conditions as $condition_id => $condition ) {
				...
				$condition_HTML_inner = ''
					...
					. $input
					. ' '
					. '<span class="button fca_remove_lightbox_condition"><span style="vertical-align:text-top" class="dashicons dashicons-no"></span> Remove Rule</span>'
			...
			<p><span class="button" id="fca_add_lightbox_condition"><span style="vertical-align:text-top" class="dashicons dashicons-plus"></span> Add Rule</span></p>
		</div>
